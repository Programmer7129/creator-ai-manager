...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default: 'bg-blue-600 text-white hover:bg-blue-700 hover:shadow-lg focus-visible:ring-blue-500',
        destructive: 'bg-red-600 text-white hover:bg-red-700 hover:shadow-lg focus-visible:ring-red-500',
        outline: 'border border-gray-300 bg-white hover:bg-gray-50 hover:shadow-md focus-visible:ring-blue-500',
